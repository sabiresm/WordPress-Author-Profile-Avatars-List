 ...
 * Description: The plugin as name suggest display list of authors in your website using widget area section. This plugin is very simple for any user to show the author in the sidebar. Simply, just drag the author widget into the sidebar and the Wordpress Author Profile Avatars List plugin show the author in sidebar.  For further information or if you have any questions/installation please do not hesitate to contact us on our website: <a href="http://themefantasy.com/plugin/wordpress-author-plugin-widget/" target="_blank">Click here</a> Step 1: Go to Widget:-> Find "Author Avatar List" -> Drag and drop whever you want to display and fill the value. Here is the link for tutorial <a href="https://s.w.org/plugins/author-profiles/screenshot-2.png" target="_blank"> link </a>
